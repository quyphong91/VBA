...
' Lay du lieu
    ...
    Range("CD_331sps").Select
    Selection.Copy
    Selection.PasteSpecial Paste:=xlPasteValues, Operation:=xlNone, SkipBlanks _
        :=False, Transpose:=False
    Range("tgddn_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg1_331)"
    Range("tgddc_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg1.2_331)"
    Range("tgpsn_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg2_331)"
    Range("tgpsc_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg3_331)"
    Range("tgdcn_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg4.2_331)"
    Range("tgdcc_331").Select
    ActiveCell.FormulaR1C1 = "=SUM(vg4_331)"
    Range("A11:J11").Select
    Selection.AutoFilter
    Selection.AutoFilter Field:=10, Criteria1:="1"
    'Sheets("CDSPS").Select
    'Range("CDSPS_lock").Select
    'ActiveCell.FormulaR1C1 = _
    ...
    'Range("CDSPS_lock").Copy
    'Range("CDSPS_lock").PasteSpecial Paste:=xlPasteValues, Operation:=xlNone, SkipBlanks _
        :=False, Transpose:=False
